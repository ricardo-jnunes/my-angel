...
import com.angel.graphics.*;
import com.angel.input.*;
import com.angel.sound.*;
import com.angel.state.*;
import com.angel.tilegame.sprites.*;
...
public class MainGameState implements GameState {
	...
	private static final String WIN_PATH_SOUNDS = "C:\\Users\\Ricardo\\Documents\\Workspaces\\myAngel\\MyAngel\\sounds\\";
	...
	private AudioInputStream soundtrack1a4;
	private AudioInputStream soundtrack5;
	private TileMap map;
	...
	public void loadResources(ResourceManager resManager) {
		...
		// load sounds
		prizeSound = resourceManager.loadSound(WIN_PATH_SOUNDS + "prize.wav");
		boopSound = resourceManager.loadSound(WIN_PATH_SOUNDS + "boop2.wav");
		music = resourceManager.loadSequence(WIN_PATH_SOUNDS + "music.midi");
		soundtrack1a4 = resourceManager.loadSoundTrack(WIN_PATH_SOUNDS + "cc_home_voyage.wav");
		soundtrack5 = resourceManager.loadSoundTrack(WIN_PATH_SOUNDS + "Bastion_Build_that_Wall.wav");
		scene01 = resourceManager.loadImage("loading.jpg");
	}
	...
	public void toggleSoundTrack(AudioInputStream soundtrack) {
		try {
			clip.stop();
			clip.drain();
			clip.close();
	...
	public void update(long elapsedTime) {
		...
		player.updateForInput(elapsedTime, checkIfInput());
	...
	public void acquirePowerUp(PowerUp powerUp) {
		...
		if (powerUp instanceof PowerUp.Star) {
			...
			map = resourceManager.loadNextMap();
			if (5 == resourceManager.getCurrentMap()) {
				toggleSoundTrack(soundtrack5);
			}
		}
	}
